  ...
  return [
    {
      ...
      payloads: {
        ...
        'HTTP Response': JSON.stringify({
          ...
          payment: { token: '0xaB45…cD89', amount: t.payment, symbol: 'USDT0' },
        }, null, 2),
      },
    },
    {
      ...
      subtitle: 'Agent A approves USDT0 + calls postTask()',
      ...
      messages: [
        { dir: 'A→chain', label: `USDT0.approve(TaskRegistry, ${t.payment})`, color: '#AA88FF', type: 'tx' },
      ...
      payloads: {
        'Transaction': JSON.stringify({
          ...
          args: { specHash: t.taskIdShort, amount: t.payment, token: 'USDT0', timeoutSeconds: 3600 },
          txHash: t.txHash1,
        }, null, 2),
    ...
    },
    {
      ...
      agentAStatus: 'Handling 402 → sending USDT0 → retrying…',
      ...
      messages: [
        ...
        { dir: 'A→chain', label: `USDT0.transfer(AgentB, ${t.payment})`, color: '#AA88FF', type: 'tx' },
