...
async function main() {
  ...
  const usdcAddress = deployment.mockUsdc

  if (!usdcAddress) {
    throw new Error("mockUsdc not found in deployments/coston2.json — run deploy-mock-usdc.js first")
  }
  ...
  console.log(`[Mint] ✅ Minted 1000 USDC to Agent A: ${agentAAddress}`)
  console.log(`[Mint] USDC contract: ${usdcAddress}`)
}
